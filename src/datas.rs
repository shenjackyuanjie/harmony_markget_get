...
pub struct AppMetric {
    ...
    pub min_hmos_api_level: i32,
    pub api_release_type: String,
    pub page_average_rating: String,
    ...
    pub page_full_average_rating: String,
...
impl From<&RawJsonData> for AppMetric {
    fn from(value: &RawJsonData) -> Self {
        Self {
            ...
            info_score: value.hot_score.clone(),
            ...
            page_average_rating: String::new(),
            page_star_1_rating_count: 0,
            page_star_2_rating_count: 0,
            page_star_3_rating_count: 0,
            page_star_4_rating_count: 0,
            page_star_5_rating_count: 0,
            page_my_star_rating: 0,
            page_total_star_rating_count: 0,
            page_only_star_count: 0,
            page_full_average_rating: String::new(),
            page_source_type: String::new(),
...
impl AppMetric {
    pub fn from_raw_data_and_star(raw_data: &RawJsonData, raw_star: &RawStarData) -> Self {
        Self {
            ...
            info_score: raw_data.hot_score.clone(),
            ...
            page_average_rating: raw_star.average_rating.clone(),
            ...
            page_full_average_rating: raw_star.full_average_rating.clone(),
